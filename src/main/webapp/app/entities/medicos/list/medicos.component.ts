...
import { EntityArrayResponseType, MedicosService } from '../service/medicos.service';
...
export class MedicosComponent implements OnInit {
  ...
  trackId = (item: IMedicos): number => this.medicosService.getMedicosIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: IMedicos[] | null): IMedicos[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.medicosService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
