...
import { sampleWithRequiredData } from '../medicos.test-samples';
...
describe('Medicos Management Component', () => {
  ...
  describe('trackId', () => {
    it('Should forward to medicosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMedicosIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMedicosIdentifier).toHaveBeenCalledWith(entity);
